...
def load_model(objname, field, agelims=[], **extras):
    ...
    agelims = [0.0, 7.477, 8.0, 8.7, (8.7 + (np.log10(tuniv*1e9) - 8.7)/3), (8.7 + 2 * (np.log10(tuniv*1e9) - 8.7)/3),
               np.log10(tuniv*1e9)]  # 0, 30 Myr, 100 Myr, 500 Myr, 3 evenly spaced to tuniv
    '''
