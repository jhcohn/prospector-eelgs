...
if __name__ == "__main__":
    ...
    for ind in range(len(allkeys)):
        ...
        ax6.errorbar(float(insfr1) / float(insfr2), sfr1[1] / sfr2[1], fmt='ko')
    ...
    ax6.set_xlim(0., 10.)
    ax6.set_ylim(0., 10.)
    ax6.plot([0., 10.], [0., 10.], color='k', linestyle='--')
    ...
    ax6.set_xticks([0.0, 2., 4., 6., 8., 10.0])  # technically works
    ax6.set_xticklabels([r'$0.0$', r'$2.0$', r'$4.0$', r'$6.0$', r'$8.0$', r'$10.0$'], size=fs_ticks)
    ax6.set_yticks([0.0, 2., 4., 6., 8., 10.0])  # technically works
    ax6.set_yticklabels([r'$0.0$', r'$2.0$', r'$4.0$', r'$6.0$', r'$8.0$', r'$10.0$'], size=fs_ticks)
