...
def load_model(objname, field, agelims=[], **extras):
    ...
    agelims = [0.0, 8.48, 8.78, 8.95, (8.95 + (np.log10(tuniv*1e9) - 8.95)/3),
               (8.95 + 2 * (np.log10(tuniv*1e9) - 8.95)/3), np.log10(tuniv*1e9)]
...
'''
RUNNING WITH
mpirun -n 4 python prospector.py --param_file=eelg_fixedmet_params.py --outfile=1824_cosmos_other --niter=2500
