...
def load_obs(field, objname, err_floor=0.05, zperr=True, **extras):
    ...
    # NEW: ADD FLUX FROM EELG_ADDMASS_PARAMS.PY FOR MASS TEST
    newpath = '/home/jonathan/.conda/envs/snowflakes/lib/python2.7/site-packages/prospector/git/newphot_12105'
    flux2 = []
    ...
    flux = np.array(flux2)
    flux_orig = np.squeeze([dat[obj_idx]['f_' + f] for f in filternames])
    print('orig', flux_orig)
