...
#     agelims[-1] = np.log10(tuniv*1e9)
    ...
    model_params[n.index('sfr_fraction')]['init'] = np.array([0.7, 0.2, 0.05, 0.03, 0.01])  # np.zeros(ncomp-1)+1./ncomp
